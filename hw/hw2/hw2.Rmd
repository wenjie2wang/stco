---
title: "STAT-6494 Advanced Statistical Computing with R -- HW 2"
author: Wenjie Wang
...
as follows. The output plot is shown in `r figr("plots", TRUE, type = "Figure")`.

```{r plots, echo=TRUE, warning=FALSE, fig.cap="Overlaid histogram and density plots."}
library(ggplot2)
N = 1e4
